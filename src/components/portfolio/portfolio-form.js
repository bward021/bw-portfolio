...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://bward.devcamp.space/portfolio/portfolio_items",
      apiAction: "post",
    };
  ...
  deleteImage(imageType) {
    console.log("Delete Imgae: ", imageType);
  }
  ...
  handleThumbDrop() {
    return {
      addedfile: (file) => {
        this.setState({ thumb_image: file });
      },
    };
  }
  ...
  handleBannerDrop() {
    return {
      addedfile: (file) => {
        this.setState({ banner_image: file });
      },
    };
  }
  handleLogoDrop() {
  ...
  handleSubmit(event) {
    // https://bward.devcamp.space/portfolio/portfolio_items
    axios({
